...
for filename in os.listdir('./data'):
	...
	model.save(f'model/{stock_name}_model.h5')
	...
	print(f'Mean Squared Error for {stock_name} is: {scaled_mse}')
	mse_for_symbol[stock_name] = scaled_mse
	...
	plt.savefig(f'graphs/{stock_name}.pdf')
	plt.close(); 

print('MSE for each symbol: ')
print(mse_for_symbol)
