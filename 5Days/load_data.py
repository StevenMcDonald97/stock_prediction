...
def csv_to_dataset(csv_path):
    ...
    ohlcv_histories_normalised = np.array([data_normalised[i  : i + history_points].copy() for i in range(len(data_normalised) - history_points-5)])
    ...
    next_day_open_values_normalised = np.array([data_normalised[:,0][i + history_points+5].copy() for i in range(len(data_normalised) - history_points-5)])
